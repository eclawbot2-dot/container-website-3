...
export default function LangToggle({
  ...
  return (
    <button
      ...
      className={`group inline-flex min-h-[44px] items-center gap-2 rounded-full border border-bone/25 bg-abyss/40 px-4 py-2.5 text-[0.7rem] font-medium uppercase tracking-wide2 text-bone/85 backdrop-blur-md transition-all duration-300 hover:border-amber-glow/70 hover:text-amber-glow ${className}`}
    >
      <span
        aria-hidden
